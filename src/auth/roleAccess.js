export const roleRouteAccess = {
  Statistician: ['/dashboard', '/profile', '/statistics', '/player-development', '/institutions', '/teams', '/competitions', '/seasons', '/games', '/reports', '/analysis','/bulk-import', '/opponent-analysis', '/settings', '/account', '/users', '/organizations', '/competitions-management', '/seasons-management', '/teams-management', '/players-management', '/audit-log'],
  ...
  'Team Manager': ['/dashboard', '/profile', '/statistics', '/player-development', '/institutions', '/teams', '/competitions', '/seasons', '/games', '/reports', '/analysis', '/opponent-analysis', '/settings', '/team-brand-settings', '/account', '/users', '/organizations', '/competitions-management', '/seasons-management', '/teams-management', '/players-management', '/audit-log'],
