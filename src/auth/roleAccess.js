export const roleRouteAccess = {
  ...
  'Team Manager': ['/dashboard', '/profile', '/institutions', '/teams', '/leagues', '/seasons', '/games', '/statistics', '/reports', '/analysis', '/analysis-import', '/opponent-analysis', '/settings', '/account', '/users', '/organizations', '/leagues-management', '/seasons-management', '/teams-management', '/players-management'],
