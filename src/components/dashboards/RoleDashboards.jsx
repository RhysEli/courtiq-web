  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} sm={6}><StatTile title="Team's Recent Games" value={summary.completed} subtitle="Completed this season" icon={SportsBasketballRoundedIcon} color={teamColors.primary} delay={0.1} /></Grid>
        <Grid item xs={12} sm={6}><StatTile title="Team's Next Game" value={summary.upcoming} subtitle="Upcoming matches" icon={EmojiEventsRoundedIcon} color={teamColors.secondary} delay={0.25} /></Grid>
      </Grid>
...
export function CoachDashboard({ data, summary, roster, nextGame, insightTags, winRate, userName, season, photoUrl }) {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} sm={6} md={4}><StatTile title="Upcoming" value={summary.upcoming} subtitle="Scheduled matches" icon={SportsBasketballRoundedIcon} color={roleTheme.glow} delay={0.1} /></Grid>
        <Grid item xs={12} sm={6} md={4}><StatTile title="Win Rate" value={winRate == null ? '—' : `${winRate}%`} subtitle="This season" icon={EmojiEventsRoundedIcon} color={teamColors.primary} delay={0.2} /></Grid>
        <Grid item xs={12} sm={6} md={4}><StatTile title="Roster" value={roster.length} subtitle="Active players" icon={FitnessCenterRoundedIcon} color={teamColors.secondary} delay={0.25} /></Grid>
      </Grid>
...
export function TeamManagerDashboard({ data, summary, myTeams, gamesByTeam, staffCount, upcomingGames, userName, season, photoUrl }) {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} sm={6} md={4}><StatTile title="Active Teams" value={myTeams.length} subtitle="Under management" icon={SportsBasketballRoundedIcon} color={roleTheme.glow} delay={0.1} /></Grid>
        <Grid item xs={12} sm={6} md={4}><StatTile title="Season Games" value={summary.total} subtitle="Total scheduled" icon={TrendingUpRoundedIcon} color={teamColors.primary} delay={0.15} /></Grid>
        <Grid item xs={12} sm={6} md={4}><StatTile title="Staff Members" value={staffCount} subtitle="Coaches & stats" icon={FitnessCenterRoundedIcon} color={teamColors.secondary} delay={0.2} /></Grid>
      </Grid>
