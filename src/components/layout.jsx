...
export default function Layout({ children, mode, toggleTheme, selectedTeam, onTeamChange, role, selectedInstitution, selectedLeague, selectedSeason }) {
  return (
    <Box sx={{ display: 'flex', minHeight: '100vh', bgcolor: 'background.default' }}>
      <Sidebar role={role} selectedSeason={selectedSeason} />
